<x-app-layout>
    ...
    <div class="max-w-2xl space-y-5">
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <form method="POST" action="{{ route('admin.settings.update') }}" class="px-6 py-5 space-y-5">
                ...
                <div class="flex items-start justify-between gap-6">
                    <div class="flex-1">
                        <p class="text-sm font-medium text-slate-800">Enable Phone OTP (SMS)</p>
                        <p class="text-xs text-slate-500 mt-0.5 leading-relaxed">
                            When enabled, OTP codes are sent via SMS to customer phone numbers.
                        ...
                        @if($phoneOtpEnabled === '0')
                            <span class="inline-flex items-center gap-1.5 mt-2 text-xs font-medium text-slate-500 bg-slate-100 px-2.5 py-1 rounded-full">
                                ...
                                Currently: Email only (SMS disabled)
                            </span>
                        @else
                            <span class="inline-flex items-center gap-1.5 mt-2 text-xs font-medium text-emerald-600 bg-emerald-50 border border-emerald-200 px-2.5 py-1 rounded-full">
                                ...
                                Currently: Email + Phone SMS enabled
                            </span>
                        @endif
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-amber-600 mt-0.5 leading-relaxed">
                                ...
                                Add your provider in <code class="bg-amber-100 px-1 py-0.5 rounded font-mono">app/Services/OtpService.php</code>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-100 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500">Configure outgoing email delivery</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('admin.settings.update') }}" class="px-6 py-5 space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="mail_encryption" class="w-full text-sm border border-slate-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <form method="POST" action="{{ route('admin.settings.update') }}" class="px-6 py-5">
                @csrf @method('PUT')
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <div class="flex items-end">
                        <button type="submit" class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition w-full sm:w-auto">
                            Send Test Email
                        </button>
                    </div>
                </div>
